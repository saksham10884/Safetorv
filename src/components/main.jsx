        ...
        <div className="justify-items-center px-2">
            <div className="upperbody w-1/2 flex flex-col items-center">
                ...
                <div className="flex md:flex-row flex-col gap-3 w-full relative">
                    ...
                    <input ref={inputref} value={form.password} className="rounded-full w-full md:w-1/2 block px-3 pr-10 p-1" placeholder="Enter password" type="password" name="password" onChange={handleChange} />
                    <img ref={ref} className="w-8 right-2 bottom-0  cursor-pointer absolute" onClick={showpassword} src="/close-eye.png" alt="" />
                </div>
